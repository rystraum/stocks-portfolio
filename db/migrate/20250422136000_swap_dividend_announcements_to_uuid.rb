class SwapDividendAnnouncementsToUuid < ActiveRecord::Migration[6.0]
  def up
    ...
    remove_foreign_key :converted_announcements, column: :dividend_announcement_id if foreign_key_exists?(:converted_announcements, column: :dividend_announcement_id)
    ...
    add_foreign_key :converted_announcements, :dividend_announcements, column: :dividend_announcement_id if !foreign_key_exists?(:converted_announcements, column: :dividend_announcement_id)
    add_foreign_key :dividend_announcements, :companies, column: :company_id if !foreign_key_exists?(:dividend_announcements, :companies)
  end
